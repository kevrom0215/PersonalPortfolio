            ...
            <div className="relative">
              ...
              <div className="rounded-2xl overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl">
                ...
                >
                  ...
                  <path d="M250,60 C147.16,60 60,147.16 60,250 C60,352.84 147.16,440 250,440 C352.84,440 440,352.84 440,250 C440,147.16 352.84,60 250,60 Z" fill="#4F46E5" />
                  <circle cx="250" cy="250" r="90" fill="#FFFFFF" />
                  <circle cx="250" cy="210" r="30" fill="#312E81" />
                  <path d="M200,290 C200,262.4 222.4,240 250,240 C277.6,240 300,262.4 300,290 C300,317.6 277.6,340 250,340 C222.4,340 200,317.6 200,290 Z" fill="#312E81" />
                </svg>
              </div>
            </div>
          </motion.div>
